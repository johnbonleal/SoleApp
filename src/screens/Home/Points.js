            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={{ paddingHorizontal: 32, paddingVertical: 16 }}>
                        <TouchableOpacity 
                            style={{ flexDirection: 'row', paddingVertical: 16, justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#D8D8D8' }}
                            >
                        ...
                        <TouchableOpacity
                            style={{ flexDirection: 'row', paddingVertical: 16, justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#D8D8D8' }}
                            onPress={() => NavigationService.navigate('Rewards')}
                        >
